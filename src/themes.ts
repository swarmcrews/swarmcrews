...
const porcelain: ThemeDefinition = {
  ...
  vars: {
    ...
    "--shadow-sm": "2px 3px 6px rgba(145, 154, 176, 0.22), -2px -2px 5px rgba(255, 255, 255, 0.72)",
    "--shadow-md": "5px 6px 14px rgba(145, 154, 176, 0.24), -4px -4px 12px rgba(255, 255, 255, 0.76)",
    "--shadow-lg": "8px 12px 28px rgba(145, 154, 176, 0.26), -6px -6px 20px rgba(255, 255, 255, 0.8)",
    "--note-blue-bg": "#e2e7f4",
