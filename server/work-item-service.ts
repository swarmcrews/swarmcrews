...
export interface WorkItemService {
  ...
  continue(input: ExistingWorkItemMutationContext & { workItemId: string; prompt: string;
    ...
    harness?: string; model?: string; permissionMode?: string; sandboxPolicy?: SandboxPolicy; thinkingConfig?: unknown; connectionIds?: string[] | undefined; skillIds?: string[];
  ...
  replyToWaitingRun(input: ExistingWorkItemMutationContext & { workItemId: string; runKey: string;
    prompt: string; displayPrompt?: string; sandboxPolicy?: SandboxPolicy; attachments?: unknown[]; continuitySource?: "system"; connectionIds?: string[] | undefined; skillIds?: string[];
